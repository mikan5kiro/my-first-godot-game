...
const PHONE_DELIVERY_ORDERED := "外卖点好了，等会应该就到了。"
const PHONE_FOOD_ORDERED := "食材订好了，等会应该就到了。"
...
# --- 单行提示：冰箱 / 餐桌 ---
const FRIDGE_PROMPT := "冰箱。要查看剩余食材吗？"
...
const STOVE_OFF_MEAL_TIME := "@虽然还有食材，但还不是吃饭的时间呢。"
